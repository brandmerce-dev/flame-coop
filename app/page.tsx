...
function renderBadge(label: string) {
  ...
  if (label === 'DI')   return <span role="img" aria-label={ariaMap[label]}><span aria-hidden="true">D</span><span aria-hidden="true" style={{ fontSize: '.65em' }}>I</span></span>;
  if (label === 'DII')  return <span role="img" aria-label={ariaMap[label]}><span aria-hidden="true">D</span><span aria-hidden="true" style={{ fontSize: '.65em' }}>II</span></span>;
  if (label === 'DIII') return <span role="img" aria-label={ariaMap[label]}><span aria-hidden="true">D</span><span aria-hidden="true" style={{ fontSize: '.65em' }}>III</span></span>;
  return label;
}
