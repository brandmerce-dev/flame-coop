  ...
  return (
    <footer id="site-footer" role="contentinfo">
      <div className="container">
        ...
        {/* Full-width contact strip: channels inline left, social icons right */}
        {(address || phone || contactEmail || facebookUrl || instagramUrl || youtubeUrl) && (
          <div className="footer__contact">
            <address className="footer__contact-info" style={{ fontStyle: 'normal' }}>
              {address && <span>{address}</span>}
              {address && phone && <span className="footer__contact-sep" aria-hidden="true">·</span>}
              {phone && <a href={telHref(phone)}>{phone}</a>}
              {(address || phone) && contactEmail && <span className="footer__contact-sep" aria-hidden="true">·</span>}
